...
int main(int argc, char** argv) {
    ...
    cout<<"Here is the first roll!(press enter)"<<endl;
    cin.get();
    ...
    //upper section
    int SS1=63, SS2=0, SS3=0, SS4=0, SS5=0, SS6=0;
    
    //lower section
    int SS7=0, SS8=0, SS9=0, SS10=120, SS11=0, SS12=0, SS13=0;
    ...
    for(int j=1;j<13;j++){
        ...
        //begin grading
        do{
            cout<<"Lets grade your hand!(press enter to continue)"<<endl;
            cin.get();
